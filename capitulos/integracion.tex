...
\begin{proof}
	...
	%continua la magia%
\end{proof}
Finalmente, obtendremos una cota del error. Para ello haremos uso de los resultados %teorema 4.5,4.49 del libro%.
\medskip
